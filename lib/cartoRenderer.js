    ...
    attachments.forEach(function(attachment) {
      ...
      for (var i = 0; i < features.length; i++) {
        ...
        var renderInstance = function(instanceName) {
          ...
          // console.log("Style for this instance", instanceStyle);
...
var cartoSelectorIsMatch = function(definition, feature, source, zoom) {
  // fconsole.log("Checking selector", definition.filters, feature);
  ...
  if (definition.filters) {
    ...
    for (var filterKey in definition.filters) {
      ...
      // console.log("k", feature.properties[filter.key]);
      // console.log("v", filter.val);
      // console.log("o", filter.op);

      // This only supports "=" comparisons right now.
      if (filter.op === "=") {
