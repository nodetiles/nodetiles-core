...
var renderText = {
  ...
  'LineString': function(text, l) {
    ...
    if (text.placement === "line") {
      ...
      if (totalLength < this.measureText(text.text).width) {
        return;
      }
      ...
      for (var i = 0, len = segmentLengths.length; i < len; i++) {
        ...
        if (segmentLengthsTotal + segmentLength >= midPoint) {
          var segmentDistance = midPoint - segmentLengthsTotal;
          ...
          if (centerPoint[0] > -100 && centerPoint[0] < 356 && centerPoint[1] > -100 && centerPoint[1] < 356) {
            ...
            if (shouldText) {
              ...
              if (text) {
                ...
                if (verticalAlign && verticalAlign.value !== "auto") {
                  ...
                  ctx.textBaseline = textInfo.offset.y < 0 ? "top" : "alphabetic";
                }
